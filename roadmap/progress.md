...
| ID | Package | Classification | Status | Depends on | Session | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
| ZF-222 | A status view for the audience that cannot sign in | extension | `not_started` | owner decision 29; ZF-207's problem split; ZF-202 | Planning only | Planned only: no route, setting, page or test exists. Blocked on decision 29 — whether any fleet fact may be read without an account — which is the whole of the package; acceptance in [ROADMAP.md](../ROADMAP.md) section 8. **ROADMAP v3.0 (19 September 2026):** decision 29 recommended adopted, off by default, sequenced after ZF-207 and built on the fleet half of its problem split (ROADMAP section 8). |
