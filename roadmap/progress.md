...
| ZF-002 | Support matrix, invariants and measurement contract | mixed | `in_progress` | ZF-001 | as ZF-001 | [support-and-measurement.md](support-and-measurement.md); the code slice (applied migrations on the CLI, `waiting`/`approved` timeline kinds, the four-way stats split) is open |
