...
var restartRequiredKeys = sync.OnceValue(func() []string {
	keys := []string{
		...
		"agent.finished_retention", "agent.docker_build_cache_mb",
		"log.format",
...
func (s *Server) settingsConfig() map[string]any {
	...
	return map[string]any{
		...
		"github": map[string]any{
			...
			"allow_workflow_cancellation": c.GitHub.AllowWorkflowCancellation,
		...
		"agent": map[string]any{
			...
			"docker_build_cache_mb": c.Agent.DockerBuildCacheMB,
		},
		...
		"oidc": map[string]any{
			...
			"link_by_username": c.OIDC.LinkByUsername,
		},
