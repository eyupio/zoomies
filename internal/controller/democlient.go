...
func (d *demoClient) GetWorkflowRun(context.Context, string, int64) (*github.WorkflowRunState, error) {
	return nil, ErrDemoFixture
}

func (d *demoClient) RerunWorkflowJob(context.Context, string, int64) error {
	return nil
}
