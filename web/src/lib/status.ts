...
/* -- jobs -------------------------------------------------------------------
 * A job is GitHub's, so it is called what GitHub calls it. Every row on the
 * Jobs page is one workflow job with a link to the same job on GitHub, and an
 ...
 * job, beside GitHub's word for it.
 * ------------------------------------------------------------------------ */
